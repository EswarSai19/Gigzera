...
if USE_S3:
    ...
    AWS_DISTRIBUTION_DIMAIN_NAME = os.getenv("AWS_DISTRIBUTION_DIMAIN_NAME") or get_ssm_parameter("AWS_DISTRIBUTION_DIMAIN_NAME")
    AWS_S3_REGION_NAME = "ap-south-1"

    # AWS_S3_CUSTOM_DOMAIN = f"{AWS_STORAGE_BUCKET_NAME}.s3.amazonaws.com"
    AWS_S3_CUSTOM_DOMAIN = AWS_DISTRIBUTION_DIMAIN_NAME
